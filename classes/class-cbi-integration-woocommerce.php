...
class CBI_Integration_WooCommerce {
	...
	public function init() {
		...
		add_filter( 'cbi_whitelist_options', array( $this, 'wc_cbi_whitelist_options' ) );
	...
	public function wc_cbi_whitelist_options( $whitelist_options ) {
		if ( ! empty( $this->_wc_options ) ) {
...
new CBI_Integration_WooCommerce();
